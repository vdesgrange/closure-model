...
dataset = Generator.generate_closure_dataset(256, 16, "viscous_burgers_high_dim_t2_64_xpi_64_nu0.04_typ2_m10_256_up16_j173.jld2", snap_kwarg, init_kwarg);
x = LinRange(0, pi, 64);
...
dataset = Generator.read_dataset("viscous_burgers_high_dim_t2_64_xpi_64_nu0.04_typ2_m10_256_up16_j173.jld2")["training_set"];
